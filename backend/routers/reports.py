...
async def submit_report(
    latitude: float = Form(..., ge=ESPOO_LAT_RANGE[0], le=ESPOO_LAT_RANGE[1]),
    longitude: float = Form(..., ge=ESPOO_LON_RANGE[0], le=ESPOO_LON_RANGE[1]),
    text_note: str | None = Form(None, max_length=1000),
